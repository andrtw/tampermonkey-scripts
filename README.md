...
A collection of [Tampermonkey](https://www.tampermonkey.net/) scripts enabling custom functionalities in various websites.

| Script | Target domains | Description |
| --- | --- | --- |
| `wordreference.js` | `www.wordreference.com/*` | <ul><li>Adds language switchers to easily translat to/from defined sets of languages</li><li>Adds Google Translate button to redirect to the searched term</li></ul> |
